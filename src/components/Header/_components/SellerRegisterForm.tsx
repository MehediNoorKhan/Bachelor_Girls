...
import useSellerRegister from "./use-seller-register";

export default function SellerRegisterForm() {
  const { open } = useModal();
  const { form, onSubmit } = useSellerRegister();
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
        ...
        <Button
          type="submit"
          className="bg-primary text-background h-11 w-full rounded-xl text-xs font-medium"
        >
          Sign Up
        </Button>
